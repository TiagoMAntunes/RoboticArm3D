class Target extends SceneObject {
    constructor(x, y, z) {
        ...
        let target = super.createSceneObjTorusRotXY(0, 0, 12, 1.5, 0.3, 10, 30, targetMAT, Math.PI / 2, Math.PI / 2)
        let support = super.createSceneObjCylinderRotX(0, 0, 5, 1, 1, 10, 20, supMAT, Math.PI / 2)
